...
// Tiled matmul: TILE_SIZE=32, TM=2, TN=2
// 1024 threads/WG (max for Metal), effective 64x64 tile, 16KB shared memory
// Tests whether more threads per workgroup helps vs fewer threads + more registers
